# This code is adapted from the MST_plus_plus repository
# Original source: https://github.com/caiyuanhao1998/MST-plus-plus/blob/master/train_code/architecture/MST_Plus_Plus.py
