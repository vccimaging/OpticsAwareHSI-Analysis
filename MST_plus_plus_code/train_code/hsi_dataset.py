...
class TrainDataset(Dataset):
    def __init__(self, data_root, crop_size, arg=True, bgr2rgb=True, stride=8, percent=None, method=None):
        ...
        for i in range(len(hyper_list)):
            ...
            mat.close()
            print(f'Ntire2022 scene {hyper_list[i]} is loaded.')
    ...
    def __getitem__(self, idx):
        ...
        if self.method == 'hprn':
            ...
            slic_input = np.transpose(slic_input, (1, 2, 0))  # Convert from C,H,W to H,W,C
...
class ValidDataset(Dataset):
    def __init__(self, data_root, bgr2rgb=True, method=None):
        self.method = method
        self.hypers = []
        self.bgrs = []
        hyper_data_path = f'{data_root}/Train_Spec/'
